...
=== FIDÉLITÉ IMAGE DE RÉFÉRENCE (RÈGLE ABSOLUE — NON NÉGOCIABLE — PRIORITÉ N°1 SUR TOUT LE RESTE) ===
🎯 OBJECTIF : rendu fiable à 100% à l'image de référence insérée par l'utilisateur. Le sujet${params.offerType === '📦 Produit' ? ' (produit)' : params.offerType === '🛎️ Service' ? ' (service / scène représentative)' : ''} affiché dans le visuel généré DOIT être STRICTEMENT le MÊME que celui de l'image de référence fournie : forme exacte, proportions, couleurs, matière, texture, packaging, étiquette, logo, typographie de l'étiquette, motifs, finitions, détails, accessoires visibles, mise en scène et éléments identifiants. Aucune variation de design, aucune réinterprétation, aucune substitution, aucun ajout d'élément absent. L'utilisateur doit reconnaître INSTANTANÉMENT son ${params.offerType === '📦 Produit' ? 'produit' : 'sujet/service'} au premier coup d'œil — fidélité visuelle 100%.
...
${params.contentType === 'video' ? `⚡ SPÉCIFIQUE VIDÉO : le sujet de l'image de référence DOIT être REPRODUIT À L'IDENTIQUE sur TOUS les plans/keyframes de la vidéo (ouverture, plans intermédiaires, plan final). Aucun plan ne peut afficher un sujet différent, modifié, redessiné ou substitué. Cohérence visuelle 100% du premier au dernier frame : mêmes formes, mêmes couleurs, mêmes proportions, mêmes détails — seuls les angles, cadrages, lumières et mouvements de caméra peuvent varier.\n` : ''}
...
• Conserver les couleurs RÉELLES du sujet (pas de virage colorimétrique, pas de saturation excessive qui changerait la teinte d'origine).
...
INTERDITS STRICTS : changer la forme, la couleur, le packaging, l'étiquette ou le logo du sujet ; remplacer par un sujet générique ressemblant ; inventer des éléments absents (texte, mention, label, certification, parfum, variante) ; modifier les proportions ; styliser/illustrer/cartooniser le sujet ; produire un rendu visiblement différent où l'utilisateur ne reconnaîtrait pas son propre sujet de référence. Cette règle PRIME sur le style visuel, l'angle marketing, le ton et toute autre directive en cas de conflit.
` : ''}
