...
3) LOGO — TOUJOURS DISCRET ET PROFESSIONNEL : taille maximale ≈ 8% de la plus petite dimension du visuel (signature, jamais hero). Placé strictement dans le coin/position demandée, avec une marge de sécurité d'au moins 10% du bord. Le logo NE DOIT JAMAIS : être surdimensionné, couvrir une partie du sujet principal, se superposer au texte overlay, dupliquer ou concurrencer le texte, être centré quand une position de coin est demandée, être déformé/rogné/recoloré, être entouré de POINTILLÉS / TIRETS / LIGNES DE CADRAGE de quelque nature que ce soit, posséder un CADRE, BORDURE, CONTOUR, FOND COLORÉ ou DÉLIMITATION VISUELLE autour de sa forme native. Le logo est une signature flottante, transparente, sans aucune boîte, sans aucun trait de séparation. Il reste un filigrane de marque élégant, parfaitement net, fond transparent préservé.
...
3) Le logo est DISCRET : taille ≈3-8% de la plus petite dimension, placé en signature dans le coin/position attendue, jamais sur le sujet, jamais surdimensionné, jamais déformé/recoloré. JAMAIS de pointillés, tirets, lignes de cadrage, cadre, bordure, contour artificiel ou fond coloré autour du logo — le logo est une signature flottante transparente sans aucune délimitation visuelle.
